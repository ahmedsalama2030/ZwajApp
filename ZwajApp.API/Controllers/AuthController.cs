...
namespace ZwajApp.API.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public AuthController(SignInManager<User> signInManager, UserManager<User> userMansger, IConfiguration config, IMapper mapper)
        {
            _userManager = userMansger;
        ...
        public async Task<IActionResult> Register(UserForRegisterDto userForRegisterDto)
        {
            ...
            var userToReturn=_mapper.Map<UsersForDetials>(userToCreate);
            if(result.Succeeded){
        ...
        public async Task<IActionResult> Login(UserForLoginDto userForLoginDto)
        {
            ...
            if(result.Succeeded){
                ...
                var users = _mapper.Map<UserForListDto>(appUser);
